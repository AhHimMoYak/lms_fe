...
const LivePage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://api.ahimmoyak.click/live/v1/${liveId}`)
      .then((response) => {
          ...
          <div className="flex gap-4">
            {/* 왼쪽: 방송 화면 + 정보 */}
              <div className="flex-grow" ref={broadcastContainerRef}>
                {/* 방송 화면 */}
                <IVSPlayer
                  streamUrl={"https://24312cd67dc1.ap-northeast-2.playback.live-video.net/api/video/v1/ap-northeast-2.503561434552.channel.BHyH8cwOvWOf.m3u8"}
                />
