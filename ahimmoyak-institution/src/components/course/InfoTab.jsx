        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={e => onEditChange({...editedCourse, duration: e.target.value})}
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={e => onEditChange({...editedCourse, description: e.target.value})}
            />
          </div>
        </div>
